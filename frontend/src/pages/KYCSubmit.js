        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            <input
              ...
              required
            />
            <input type="file" accept="image/*,.pdf" onChange={handleDocumentFile} />
            <p className="form-hint">
              {selectedFileName ? `Selected file reference: ${selectedFileName}` : 'You can type a URL or choose a file name reference.'}
            </p>
            {previewUrl && (
              <div className="kyc-preview" style={{ marginTop: 12 }}>
                {selectedFileName.toLowerCase().endsWith('.pdf') ? (
                  <iframe src={previewUrl} title="Document preview" width="100%" height="400px" />
                ) : (
